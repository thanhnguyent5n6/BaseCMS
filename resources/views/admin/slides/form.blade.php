...
@section('page_title')
    @if($is_update) Cập nhật Slide @else Thêm mới Slide @endif
...
@section('page_content')
    <div class="card card-custom gutter-b">
        ...
        <!--begin::Form-->
        <form method="POST" @if($is_update) action="{{ route('admin.slide.update') }}" @else action="{{ route('admin.slide.store') }}" @endif
            ...
            <div class="card-body">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <label for="example-search-input" class="col-2 col-form-label">Tên Slide</label>
                        <div class="col-10">
                    ...
                    <div class="form-group row">
                        <label for="example-email-input" class="col-2 col-form-label">Ảnh Slide:</label>
                        <div class="col-10">
                            ...
                            <div id="input-file-name" style="margin-top: 30px;">
                                @if($is_update && isset($data_item->image->url))
                                    <div class="old-img">
                                        <div class="image-input image-input-outline">
                                            <div class="image-input-wrapper" style="background-image: url('{{ asset(@$data_item->image->url) }}')"></div>
                                        ...
                                        <span class="form-text text-muted">{{ @$data_item->name }}</span>
                                        <input type="hidden" value="{{ @$data_item->image_id }}" name="image_id">
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-10">
                                ...
                                <a href="{{ route('admin.slide.index') }}" class="btn btn-secondary">Quay lại</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page_js')
    ...
    @include('admin.slides.script_file_upload')
    <!--end::Page Scripts-->
    <script>
