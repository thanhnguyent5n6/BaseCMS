    ...
    var SlideDatatable = function () {
        ...
        var demo = function () {
            ...
            var datatable = $('.kt-datatable').KTDatatable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        autoHide: false,
                        template: function (row) {
                            let urlEdit = "{{ route('admin.slide.edit',['id' => 'txt_edit_id']) }}";
            ...
            $('#btn_delete_record').on('click', function () {
                ...
                if (ids.length == 0) {
                    alert("Bạn chưa chọn Slide!");
                    return false;
                }

                if (confirm('Bạn có chắc muốn xóa ' + ids.length + ' Slide này?')) {
                    let urlDelete = `{{ route('admin.slide.destroy') }}`;
                    $.ajax({
                        url: urlDelete,
                        type: "POST",
                        data: {ids: ids},
