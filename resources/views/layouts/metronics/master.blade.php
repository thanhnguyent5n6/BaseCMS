...
<head><base href="">
    ...
    <link href="{{ asset('assets/css/themes/layout/brand/dark.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/themes/layout/aside/dark.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
...
<!--end::Main-->
<!-- begin::User Panel-->
@include('layouts.metronics.includes.user_panel')
<!-- end::User Panel-->
<!--begin::Scrolltop-->
