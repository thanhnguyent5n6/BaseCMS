        ...
        <div class="v2_breadcrumb_main">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('portal.post') }}">Góc tư vấn</a></li>
                    <li><a href="javascript:;">{{ @$post->title }}</a></li>
                </ul>
            </div>
        </div>
        <!-- End Breadcrumbs -->
                ...
                <div class="v2_bnc_product_page_right">
                                                                ...
                                                                <div class="v2_bnc_pr_item">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                                                        <figcaption class="v2_bnc_pr_item_boxdetails">
                                                                            <!-- Products Name -->
                                                                            <h3 class="v2_bnc_pr_item_name no-top-space">
                                                                                <a
                                                                            ...
                                                                            <div class="v2_bnc_pr_item_price_main">
                                                                                <p class="v2_bnc_pr_item_price">{{ number_format(@$product_new->price) }}
                                                                                    đ</p>
                                                                            </div>
                                                                            <!-- End Price -->
                                                                        </figcaption>
                    ...
                    <div class="item">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="v2_bnc_news_details_view"><a href="javascript:;" class="v2_bnc_details_img_big"
                                                                     title="{{ @$post->title }}"><img
                                        src="{{ asset(@$post->thumbnail) }}"
                                        alt="{{ @$post->title }}"
                                        class="img-responsive"></a>
                                <div class="v2_bnc_news_details_title"><h2>{{ @$post->title }}</h2>
                                    <time class="v2_bnc_create_time"><i class="fa fa-calendar-o"></i> Ngày đăng :
